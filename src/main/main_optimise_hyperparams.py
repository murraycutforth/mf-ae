...
def main():
    ...
    study.optimize(objective, n_trials=3, n_jobs=1, timeout=None)
    ...
    fig.savefig(OUTDIR / 'contour.png')
    fig = plot_edf(study)
    fig.savefig(OUTDIR / 'edf.png')
    fig = plot_intermediate_values(study)
    fig.savefig(OUTDIR / 'intermediate_values.png')
    fig = plot_optimization_history(study)
    fig.savefig(OUTDIR / 'optimization_history.png')
    fig = plot_parallel_coordinate(study)
    fig.savefig(OUTDIR / 'parallel_coordinate.png')
    fig = plot_param_importances(study)
    fig.savefig(OUTDIR / 'param_importances.png')
    fig = plot_rank(study)
    fig.savefig(OUTDIR / 'rank.png')
    fig = plot_slice(study)
    fig.savefig(OUTDIR / 'slice.png')
    fig = plot_timeline(study)
    fig.savefig(OUTDIR / 'timeline.png')
...
def objective(trial):
    ...
    feat_map_sizes_str = trial.suggest_categorical('feat_map_sizes', ['4_4_4_4', '8_8_8_8'])
