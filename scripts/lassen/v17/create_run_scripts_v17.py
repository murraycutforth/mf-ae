...
def main():
    search_args = {
        'data-dir': ['/usr/WS1/cutforth1/data-mf-ae/v7_spheres/SIGNED_DISTANCE_EXACT',
                     '/usr/WS1/cutforth1/data-mf-ae/v7_spheres/SIGNED_DISTANCE_APPROXIMATE',
                     '/usr/WS1/cutforth1/data-mf-ae/v7_spheres/HEAVISIDE',
                     '/usr/WS1/cutforth1/data-mf-ae/v7_spheres/TANH_EPSILON0.0078125',
                        '/usr/WS1/cutforth1/data-mf-ae/v7_spheres/TANH_EPSILON0.015625',
                        '/usr/WS1/cutforth1/data-mf-ae/v7_spheres/TANH_EPSILON0.03125',
                        '/usr/WS1/cutforth1/data-mf-ae/v7_spheres/TANH_EPSILON0.0625',
                     ],
        'seed': [0]
    }
...
def create_param_str(i, combination):
    ...
    param_str = param_str.replace("/usr/WS1/cutforth1/data-mf-ae/v7_spheres/", "")
