...
conda run -n genmodel_env accelerate launch ./src/main/main_train.py  --model-type conv_with_fc --dim 32 --dataset-type volumetric --num-dl-workers 0 --batch-size 1 --num-epochs 5 --lr 0.0001 --loss l1 --dim-mults 1 2 4 8 8 4 --block-type 1 --z-channels 4 --max-samples 25000 --data-dir /usr/workspace/cutforth1/data-mf-ae/patched_hit_experiment/HEAVISIDE --seed 4 --fc-layers 4096 512 128 --run-name interfacial_ae_v26_run_03_datadirHEAVISIDE_seed4_fclayers4096512128
