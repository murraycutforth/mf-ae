...
def main():
    search_args = {
        'data-dir': ['/usr/workspace/cutforth1/sphere_data/HEAVISIDE',
                        '/usr/workspace/cutforth1/sphere_data/SIGNED_DISTANCE_EXACT',
                        '/usr/workspace/cutforth1/sphere_data/SIGNED_DISTANCE_APPROXIMATE',
                        '/usr/workspace/cutforth1/sphere_data/TANH_EPSILON0.0078125',
                        '/usr/workspace/cutforth1/sphere_data/TANH_EPSILON0.015625',
                        '/usr/workspace/cutforth1/sphere_data/TANH_EPSILON0.03125',
                        '/usr/workspace/cutforth1/sphere_data/TANH_EPSILON0.0625',
                     ],
        'seed': [0, 42, 8]
    }
