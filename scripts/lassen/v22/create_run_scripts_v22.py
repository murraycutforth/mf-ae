...
def main():
    search_args = {
        'data-dir': ['/usr/workspace/cutforth1/data-mf-ae/spheres_mu_2.50/SIGNED_DISTANCE_EXACT',
                     '/usr/workspace/cutforth1/data-mf-ae/spheres_mu_2.50/SIGNED_DISTANCE_APPROXIMATE',
