...
VERSION = 35  # Compare effect of training set size


def main():
    search_args = {
        'data-dir': [
            '/usr/workspace/cutforth1/data-mf-ae/spheres_mu_1.00/SIGNED_DISTANCE_EXACT',
...
def create_param_str(i, combination):
    ...
    param_str = param_str.replace("/usr/workspace/cutforth1/data-mf-ae/", "")
