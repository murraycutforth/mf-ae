...
conda run -n genmodel_env accelerate launch ./src/main/main_train.py --debug  --act-type silu --lr 1e-05 --model-type baseline --dim 32 --dataset-type volumetric --num-dl-workers 0 --batch-size 1 --num-epochs 100 --loss l1 --dim-mults 1 2 4 8 8 8 --block-type 1 --z-channels 4 --data-dir /usr/workspace/cutforth1/data-mf-ae/spheres_mu_1.00/SIGNED_DISTANCE_EXACT --seed 4 --run-name run_debug_v35
