...
def main():
    search_args = {
        'data-dir': ['/usr/WS1/cutforth1/data-mf-ae/v5_ellipsoids/SIGNED_DISTANCE_EXACT',
                     ...
                     '/usr/WS1/cutforth1/data-mf-ae/v5_ellipsoids/TANH_EPSILON0.0078125',
                        '/usr/WS1/cutforth1/data-mf-ae/v5_ellipsoids/TANH_EPSILON0.015625',
...
def create_param_str(i, combination):
    ...
    param_str = param_str.replace('/usr/WS1/cutforth1/data-mf-ae/v5_ellipsoids/', '')
